...
class Query:
    ...
    def fetch_region(self):
        ...
        query = """
        SELECT DISTINCT unnest(xpath('//AirportCode/Countries/Country/Regions/Region/@iso_region', xml))::text as region
        FROM imported_documents
        ORDER BY region
        """
    ...
    def fetch_airport(self):
        ...
        query = """
        SELECT DISTINCT unnest(xpath('//AirportCode/Countries/Country/Regions/Region/Airports/Airport/@name', xml))::text as airport
        FROM imported_documents
        ORDER BY airport
        """
